    ...
    <div className='flex items-center justify-between py-4'>
     ...
     <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3 '>
            ...
            sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all
            duration-700'>
        ...
        <div className='flex items-center gap-2 sm:gap-5'>
            ...
            sm:px-10 text-sm rounded-full cursor-pointer hover:scale-105 transition'>Login</button>
        </div>
        }
