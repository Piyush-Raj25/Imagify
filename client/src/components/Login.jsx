...
backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      ...
      className='relative bg-white p-10 rounded-xl text-slate-500' >
        ...
        {state !== 'Login' && <div className='border px-4 py-1 flex items-center gap-2 
        rounded-full mt-4 w-64'>
        ...
        <div className='border px-4 py-1 flex items-center gap-2 
        rounded-full mt-5 w-64'>
